...
<template>
  <div class="border-b border-line py-3 px-[1.875rem] flex items-center justify-between gap-4 bg-bg2 sticky top-0 z-20">
    <div class="flex items-center gap-3.5 min-w-0">
      <button
        class="flex lg:hidden items-center justify-center w-9 h-9 flex-none text-base text-ink bg-transparent border border-line cursor-pointer hover:border-ink"
    ...
    <div class="flex items-center gap-2.5">
      ...
      <AppButton to="/join" variant="dark" size="sm" class="hidden lg:inline-flex">JOIN THE CLUB →</AppButton>
    </div>
  </div>
</template>
